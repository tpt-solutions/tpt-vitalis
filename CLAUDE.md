# CLAUDE.md — Workspace orientation for Claude-based agents

This is a mirror of [`AGENTS.md`](./AGENTS.md) for Claude-based coding agents.
If the two ever disagree, `AGENTS.md` is authoritative. Do not maintain divergent
content here; edit `AGENTS.md` and copy it over.
